...
SECRET_KEY = "django-insecure--m&w$%#b3v=4ucq27az0p)2est(&#ts7^!(ya07=1mk6b%-2+6"
...
MIDDLEWARE = [
    ...
    "financial_tracker_backend.middleware.TokenToAuthorizationHeaderMiddleware",
]
...
DATABASES = {
       "default": {
        ...
        'NAME': 'db_dev_1',  # Replace with your database name
